...
class GreetingControllerUnitTest {
    ...
    internal fun retrieveGreeting() {
        ...
        every { greetingServiceMock.retrieveGreeting(any()) } returns "$name, Hello from default user!!"
        ...
        Assertions.assertEquals("$name, Hello from default user!!", result.responseBody)
    }
}